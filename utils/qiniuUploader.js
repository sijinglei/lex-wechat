;(function () {
  let BASE_URL = 'https://fic.iyishang.com.cn/server' //线上地址
  ...
  var config = {
    ...
    qiniuUploadTokenURL: BASE_URL + '/user/query/uploadToken',
    // uptokenFunc 这个属性的值可以是一个用来生成uptoken的函数，详情请见 README.md
    qiniuUploadTokenFunction: function () {},
    domain: 'https://fic-download.iyishang.com.cn', //文件下载前缀
    ...
    var uploadTask = wx.uploadFile({
      ...
      success: function (res) {
        ...
        try {
          ...
          var fileURL = dataObject.data.url
